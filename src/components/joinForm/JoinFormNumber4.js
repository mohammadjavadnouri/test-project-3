...
import {Container, Row, Col, FormGroup, Button, Modal} from 'react-bootstrap';
...
const JoinFormNumber4 = () => (
    <Modal show={true} className="joinFormModal">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="240.952" height="171.036" viewBox="0 0 240.952 171.036">
        <g id="loading__two_color" transform="translate(-35.16 -48.93)">
