...
const JoinDrugStore = () => (
    ...
    <Col sm={6} className="left">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink" 
            width="500" height="400" viewBox="0 150 400 400"  className="leftImage">
            <g id="Group_5431" data-name="Group 5431" transform="translate(-194 -2870)">
                <g id="Group_5401" data-name="Group 5401" transform="translate(9615 -6985)">
